            ...
            <ul class="list-unstyled">
                <li class="ps-3">
                    <a href=" {{ route('admin.project.index') }} "
                        class="  {{ Route::CurrentRouteName() === 'admin.project.index' || Route::CurrentRouteName() === 'admin.project.create' || Route::CurrentRouteName() === 'admin.project.edit' || Route::CurrentRouteName() === 'admin.project.show' ? 'active' : '' }} ">
